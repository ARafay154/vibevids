...
import { ACCOUNTING, FINANCE_PRICING, FRACTIONAL_CFO, TAXPCOMPLIANCE_PRICING, TAXPLANNING_PRICING, TAXRESOLUTION_PRICING, } from '../../assets/data/DummyData'
import * as Animatable from 'react-native-animatable';

const AnimatableView = Animatable.createAnimatableComponent(View);


const TaxPricingScreen = (props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Scrollable containerStyle={styles.scrollView}>
                ...
                {/* Tax Planning Prices */}
                <Label style={styles.typeHeading}>Tax Planning Prices</Label>
                {TAXPLANNING_PRICING.map((item, index) => (
                ...
                <Label style={styles.typeHeading}>Tax Compliance Prices</Label>
                {TAXPCOMPLIANCE_PRICING.map((item, index) => (
                    <AnimatableView animation="pulse" key={index}>
                ...
                <Label style={styles.typeHeading}>Tax Resolution Prices</Label>
                {TAXRESOLUTION_PRICING.map((item, index) => (
                    <AnimatableView animation="pulse" key={index}>
...
export default TaxPricingScreen
